...
class DeductionTypeController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('payroll::deduction-types.create', compact('categoryLabels', 'nextOrder'));
    }
    ...
    public function edit(DeductionType $deductionType)
    {
        ...
        return view('payroll::deduction-types.edit', compact('deductionType', 'categoryLabels'));
    }
