...
class HdmfCalExport implements FromCollection, WithTitle, WithEvents
{
    ...
    private function compute(): void
    {
        ...
        foreach ($entries as $entry) {
            ...
            $this->rows[] = [
                ...
                $emp->hdmf_cal_app_no ?? '',   // col B - APPLICATION NUMBER
                $emp->last_name       ?? '',   // col C
    ...
    public function title(): string { return 'HDMF CAL'; }
    ...
    private function buildSheet(\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $ws): void
    {
        ...
        // Form reference top-right — col I row 1 (CAL uses col I, MPL uses col H)
        ...
        foreach ($this->rows as $row) {
            ...
            $ws->getRowDimension($r)->setRowHeight(20.1);
            $r++;
        }
        ...
        foreach (['A' => 18.71, 'B' => 20.71, 'C' => 15.71, 'D' => 18.71,
                  'E' => 12.71, 'F' => 14.71, 'G' => 9.71, 'H' => 11.71, 'I' => 12.71] as $col => $w) {
