...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/employees/{employee}/deductions',    [EmployeeController::class, 'deductions'])->name('employees.deductions');
    Route::post('/employees/{employee}/deductions',   [EmployeeController::class, 'updateDeductions'])->name('employees.deductions.update');
    ...
    Route::get('/payroll/{payrollBatch}/entries',     [PayrollEntryController::class, 'index'])->name('payroll.entries.index');
    Route::get('/payroll/{payrollBatch}/entries/{entry}', [PayrollEntryController::class, 'show'])->name('payroll.entries.show');
    Route::put('/payroll/{payrollBatch}/entries/{entry}', [PayrollEntryController::class, 'update'])->name('payroll.entries.update');
    Route::get('/payroll/{payrollBatch}/payslip/{entry}', [PayrollEntryController::class, 'payslip'])->name('payroll.payslip');

    // Special Payroll
    Route::resource('special-payroll', SpecialPayrollController::class);
    Route::post('/special-payroll/{specialPayrollBatch}/approve', [SpecialPayrollController::class, 'approve'])->name('special-payroll.approve');

    // Office Orders
    Route::resource('office-orders', OfficeOrderController::class);
    Route::post('/office-orders/{officeOrder}/approve', [OfficeOrderController::class, 'approve'])->name('office-orders.approve');
    ...
    Route::post('/tev/{tevRequest}/itinerary',        [TevItineraryController::class, 'store'])->name('tev.itinerary.store');
    Route::put('/tev/{tevRequest}/itinerary/{line}',  [TevItineraryController::class, 'update'])->name('tev.itinerary.update');
    Route::delete('/tev/{tevRequest}/itinerary/{line}', [TevItineraryController::class, 'destroy'])->name('tev.itinerary.destroy');
    ...
    Route::get('/reports/tev/{tevRequest}/itinerary', [ReportController::class, 'tevItinerary'])->name('reports.tev-itinerary');
    Route::get('/reports/tev/{tevRequest}/travel-completed', [ReportController::class, 'tevTravelCompleted'])->name('reports.tev-travel-completed');
    Route::get('/reports/tev/{tevRequest}/annex-a',   [ReportController::class, 'tevAnnexA'])->name('reports.tev-annex-a');
...
/*
|--------------------------------------------------------------------------
| AJAX API Routes (SIT lookup, etc.)
|--------------------------------------------------------------------------
*/
