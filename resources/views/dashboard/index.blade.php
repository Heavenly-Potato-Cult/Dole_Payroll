...
@role('accountant')
    ...
    <div class="db-row">
        ...
        <div class="db-card">
            ...
            <div class="db-card-body">
                @php
                    $pendingBatches = \App\Models\PayrollBatch::with('creator')->where('status','pending_accountant')->orderByDesc('id')->limit(5)->get();
                @endphp
        ...
        <div class="db-card">
            ...
            <div class="db-card-body">
                @php
                    $pendingTevs = \App\Models\TevRequest::with('employee')->where('status','submitted')->orderByDesc('id')->limit(5)->get();
                @endphp
